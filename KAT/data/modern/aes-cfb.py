# KAT/data/modern/aes-cfb.py
# Known Answer Tests for AES-CFB (Cipher Feedback Mode, segment size 128)

meta = {
    "group": "modern",
    "algorithm": "AES-CFB",
    "source": "NIST SP 800-38A (2001) Appendix F.3",
    "source_ref": "https://nvlpubs.nist.gov/nistpubs/Legacy/SP/nistspecialpublication800-38a.pdf",
    "generated_by": "GitHub Copilot (Claude Sonnet 4.6)",
    "date": "2025-07-01",
    "notes": (
        "AES in Cipher Feedback mode with 128-bit segment size (CFB128). "
        "Case fields: key_bits, key_hex, iv_hex, plaintext_hex, ciphertext_hex. "
        "Vectors from NIST SP 800-38A Appendix F.3.13 (CFB128-AES128)."
    ),
}

cases = [
    # F.3.13 CFB128-AES128.Encrypt (4 blocks combined)
    {
        "id": 1,
        "key_bits": 128,
