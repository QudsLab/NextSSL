 ...
 * Available modes: _random, _drbg, _password, _hd
 * (HASH/KDF/UDBF modes require the object pattern — too many params for one-shot)
 * --------------------------------------------------------------------- */

/* Ed25519 */
int keygen_ed25519_random(uint8_t pk[32], uint8_t sk[64]);
int keygen_ed25519_drbg(const uint8_t *seed, size_t slen, const char *label,
                        uint8_t pk[32], uint8_t sk[64]);
int keygen_ed25519_password(const uint8_t *pwd, size_t plen,
                            const uint8_t *salt, size_t slen,
                            const keygen_argon2_params_t *params,
                            uint8_t pk[32], uint8_t sk[64]);
int keygen_ed25519_hd(const uint8_t *master, size_t mlen, const char *path,
                      uint8_t pk[32], uint8_t sk[64]);

/* X25519 */
int keygen_x25519_random(uint8_t pk[32], uint8_t sk[32]);
int keygen_x25519_drbg(const uint8_t *seed, size_t slen, const char *label,
                       uint8_t pk[32], uint8_t sk[32]);
int keygen_x25519_password(const uint8_t *pwd, size_t plen,
                           const uint8_t *salt, size_t slen,
                           const keygen_argon2_params_t *params,
                           uint8_t pk[32], uint8_t sk[32]);
...
int keygen_ml_kem_512_password(const uint8_t *pwd, size_t plen,
                               const uint8_t *salt, size_t slen,
                               const keygen_argon2_params_t *params,
                               uint8_t *pk, uint8_t *sk);
...
int keygen_ml_kem_768_drbg(const uint8_t *seed, size_t slen, const char *label,
                           uint8_t *pk, uint8_t *sk);
int keygen_ml_kem_768_password(const uint8_t *pwd, size_t plen,
                               const uint8_t *salt, size_t slen,
                               const keygen_argon2_params_t *params,
                               uint8_t *pk, uint8_t *sk);
...
int keygen_ml_kem_1024_drbg(const uint8_t *seed, size_t slen, const char *label,
                            uint8_t *pk, uint8_t *sk);
int keygen_ml_kem_1024_password(const uint8_t *pwd, size_t plen,
                                const uint8_t *salt, size_t slen,
                                const keygen_argon2_params_t *params,
                                uint8_t *pk, uint8_t *sk);
...
int keygen_ml_dsa_44_drbg(const uint8_t *seed, size_t slen, const char *label,
                          uint8_t *pk, uint8_t *sk);
int keygen_ml_dsa_44_password(const uint8_t *pwd, size_t plen,
                              const uint8_t *salt, size_t slen,
                              const keygen_argon2_params_t *params,
                              uint8_t *pk, uint8_t *sk);
...
int keygen_ml_dsa_65_drbg(const uint8_t *seed, size_t slen, const char *label,
                          uint8_t *pk, uint8_t *sk);
int keygen_ml_dsa_65_password(const uint8_t *pwd, size_t plen,
                              const uint8_t *salt, size_t slen,
                              const keygen_argon2_params_t *params,
                              uint8_t *pk, uint8_t *sk);
...
int keygen_ml_dsa_87_drbg(const uint8_t *seed, size_t slen, const char *label,
                          uint8_t *pk, uint8_t *sk);
int keygen_ml_dsa_87_password(const uint8_t *pwd, size_t plen,
                              const uint8_t *salt, size_t slen,
                              const keygen_argon2_params_t *params,
                              uint8_t *pk, uint8_t *sk);
