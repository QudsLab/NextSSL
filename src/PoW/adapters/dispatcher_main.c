...
extern POWAlgoAdapter* pow_adapter_sha224(void);
...
extern POWAlgoAdapter* pow_adapter_sha3_224(void);
extern POWAlgoAdapter* pow_adapter_sha3_256(void);
extern POWAlgoAdapter* pow_adapter_sha3_384(void);
...
POWAlgoAdapter* pow_adapter_get(const char* algorithm_id) {
    ...
    if (strcmp(algorithm_id, "sha224") == 0) return pow_adapter_sha224();
    ...
    if (strcmp(algorithm_id, "sha3_224") == 0) return pow_adapter_sha3_224();
    if (strcmp(algorithm_id, "sha3_256") == 0) return pow_adapter_sha3_256();
    if (strcmp(algorithm_id, "sha3_384") == 0) return pow_adapter_sha3_384();
