...
int leyline_md4(const uint8_t *msg, size_t len, uint8_t *out) {
    md4_hash(msg, len, out);
    return 0;
}

int leyline_md2(const uint8_t *msg, size_t len, uint8_t *out) {
    md2_hash(msg, len, out);
    return 0;
}

int leyline_sha0(const uint8_t *msg, size_t len, uint8_t *out) {
    sha0_hash(msg, len, out);
    return 0;
}

int leyline_ripemd128(const uint8_t *msg, size_t len, uint8_t *out) {
    ripemd128_hash(msg, len, out);
    return 0;
}

int leyline_ripemd256(const uint8_t *msg, size_t len, uint8_t *out) {
    ripemd256_hash(msg, len, out);
    return 0;
}

int leyline_ripemd320(const uint8_t *msg, size_t len, uint8_t *out) {
    ripemd320_hash(msg, len, out);
    return 0;
}

int leyline_has160(const uint8_t *msg, size_t len, uint8_t *out) {
