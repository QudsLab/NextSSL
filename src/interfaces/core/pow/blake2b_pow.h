...
#ifndef NEXTSSL_CORE_POW_BLAKE2B_POW_H
#define NEXTSSL_CORE_POW_BLAKE2B_POW_H
 ...
 */
NEXTSSL_CORE_API int nextssl_partial_pow_blake2b_hash(
 ...
 */
NEXTSSL_CORE_API int nextssl_partial_pow_blake2b_verify(
    const uint8_t *password, size_t password_len,
    const uint8_t *salt, size_t salt_len,
    uint32_t iterations,
 ...
 */
NEXTSSL_CORE_API int nextssl_partial_pow_blake2b_selftest(void);

#endif /* NEXTSSL_CORE_POW_BLAKE2B_POW_H */
