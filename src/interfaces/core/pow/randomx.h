...
#ifndef NEXTSSL_CORE_POW_RANDOMX_H
#define NEXTSSL_CORE_POW_RANDOMX_H
 ...
 */
NEXTSSL_CORE_API int nextssl_partial_pow_randomx_init(
 ...
 * @return 0 on success, negative on error
 */
NEXTSSL_CORE_API int NEXTSSL_CORE_POW_RANDOMX_Hash(
    void *vm_handle,
 ...
 */
NEXTSSL_CORE_API void nextssl_partial_pow_randomx_destroy(
    void *vm_handle);
 ...
 */
NEXTSSL_CORE_API int nextssl_partial_pow_randomx_selftest(void);

#endif /* NEXTSSL_CORE_POW_RANDOMX_H */
