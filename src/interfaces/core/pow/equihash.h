...
#ifndef NEXTSSL_CORE_POW_EQUIHASH_H
#define NEXTSSL_CORE_POW_EQUIHASH_H
 ...
 */
NEXTSSL_CORE_API int nextssl_partial_pow_equihash_solve(
 ...
 */
NEXTSSL_CORE_API int nextssl_partial_pow_equihash_verify(
    const uint8_t *input, size_t input_len,
    uint32_t n, uint32_t k,
 ...
 */
NEXTSSL_CORE_API int nextssl_partial_pow_equihash_selftest(void);

#endif /* NEXTSSL_CORE_POW_EQUIHASH_H */
