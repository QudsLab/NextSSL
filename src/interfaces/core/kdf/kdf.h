...
#ifndef NEXTSSL_CORE_KDF_H
#define NEXTSSL_CORE_KDF_H
...
#ifndef NEXTSSL_CORE_KDF_H_PRIMITIVE
#define NEXTSSL_CORE_KDF_H_PRIMITIVE
 ...
 * ```c
 * uint8_t okm[64];
 * NEXTSSL_CORE_KDF_H_PRIMITIVEkdf(
 *     NEXTSSL_HKDF_SHA256,
 *     salt, 16,
 *     shared_secret, 32,
 *     "app v1.0", 8,
 ...
 */
NEXTSSL_CORE_API int
NEXTSSL_CORE_KDF_H_PRIMITIVEkdf_extract(
    nextssl_hkdf_algorithm_t algorithm,
    const uint8_t *salt,
    size_t salt_len,
    const uint8_t *ikm,
 ...
 */
NEXTSSL_CORE_API int
NEXTSSL_CORE_KDF_H_PRIMITIVEkdf_expand(
    nextssl_hkdf_algorithm_t algorithm,
    const uint8_t *prk,
    size_t prk_len,
    const uint8_t *info,
...
#endif /* NEXTSSL_CORE_KDF_H_PRIMITIVE */
...
#ifndef NEXTSSL_CORE_KDF_H_AGGREGATE
#define NEXTSSL_CORE_KDF_H_AGGREGATE
 ...
 */
NEXTSSL_CORE_API int nextssl_base_kdf_argon2id(
 ...
 * @compliance RFC 8018
 */
NEXTSSL_CORE_API int nextssl_base_kdf_pbkdf2_sha256(
    const uint8_t *password, size_t password_len,
    const uint8_t *salt, size_t salt_len,
    uint32_t iterations,
    uint8_t *output, size_t output_len);
 ...
 */
NEXTSSL_CORE_API int nextssl_base_kdf_selftest(void);

#endif /* NEXTSSL_CORE_KDF_H_AGGREGATE */

#endif /* NEXTSSL_CORE_KDF_H */
