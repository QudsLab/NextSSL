...
#ifndef NEXTSSL_CORE_KDF_PBKDF2_H
#define NEXTSSL_CORE_KDF_PBKDF2_H
 ...
 */
NEXTSSL_CORE_API int nextssl_partial_pow_pbkdf2_sha256(
 ...
 * @return 0 on success, negative on error
 */
NEXTSSL_CORE_API int nextssl_partial_pow_pbkdf2_sha512(
    const uint8_t *password, size_t password_len,
    const uint8_t *salt, size_t salt_len,
    uint32_t iterations,
    size_t dklen, uint8_t *out);
 ...
 */
NEXTSSL_CORE_API int nextssl_partial_pow_pbkdf2_verify(
    const uint8_t *password, size_t password_len,
    const uint8_t *salt, size_t salt_len,
    uint32_t iterations,
 ...
 */
NEXTSSL_CORE_API int nextssl_partial_pow_pbkdf2_selftest(void);

#endif /* NEXTSSL_CORE_KDF_PBKDF2_H */
