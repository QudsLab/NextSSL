...
#ifndef NEXTSSL_CORE_ENCODING_RADIX_H
#define NEXTSSL_CORE_ENCODING_RADIX_H
 ...
 * @return 0 on success, negative on error
 */
NEXTSSL_BASE_API int NEXTSSL_CORE_ENCODING_RADIX_Hex_encode(
    const uint8_t *input, size_t input_len,
    char *output, size_t output_size);
 ...
 * @return 0 on success, negative on error
 */
NEXTSSL_BASE_API int NEXTSSL_CORE_ENCODING_RADIX_Hex_decode(
    const char *input, size_t input_len,
    uint8_t *output, size_t output_size,
    size_t *output_len);
...
#endif /* NEXTSSL_CORE_ENCODING_RADIX_H */
