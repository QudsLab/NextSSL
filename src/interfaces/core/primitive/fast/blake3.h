/**
 * @file blake3.h
 * @brief Layer 2 (Core) - BLAKE3 Hash Function Interface
 * 
...
#ifndef NEXTSSL_CORE_PRIMITIVE_FAST_BLAKE3_H
#define NEXTSSL_CORE_PRIMITIVE_FAST_BLAKE3_H
...
#endif /* NEXTSSL_CORE_PRIMITIVE_FAST_BLAKE3_H */
