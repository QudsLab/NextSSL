/**
 * @file blake2s.h
 * @brief Layer 2 (Core) - BLAKE2s Hash Function Interface
 * 
...
#ifndef NEXTSSL_CORE_PRIMITIVE_FAST_BLAKE2S_H
#define NEXTSSL_CORE_PRIMITIVE_FAST_BLAKE2S_H
...
#endif /* NEXTSSL_CORE_PRIMITIVE_FAST_BLAKE2S_H */
