/**
 * @file sha3.h
 * @brief Layer 2 (Core) - SHA-3 Family Hash Functions Interface
 * 
...
#ifndef NEXTSSL_CORE_PRIMITIVE_FAST_SHA3_H
#define NEXTSSL_CORE_PRIMITIVE_FAST_SHA3_H
...
#endif /* NEXTSSL_CORE_PRIMITIVE_FAST_SHA3_H */
