/**
 * @file sha2.h
 * @brief Layer 2 (Core) - SHA-2 Family Hash Functions Interface
 * 
...
#ifndef NEXTSSL_CORE_PRIMITIVE_FAST_SHA2_H
#define NEXTSSL_CORE_PRIMITIVE_FAST_SHA2_H
...
#endif /* NEXTSSL_CORE_PRIMITIVE_FAST_SHA2_H */
