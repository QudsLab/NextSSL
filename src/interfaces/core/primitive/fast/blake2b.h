/**
 * @file blake2b.h
 * @brief Layer 2 (Core) - BLAKE2b Hash Function Interface
 * 
...
#ifndef NEXTSSL_CORE_PRIMITIVE_FAST_BLAKE2B_H
#define NEXTSSL_CORE_PRIMITIVE_FAST_BLAKE2B_H
...
#endif /* NEXTSSL_CORE_PRIMITIVE_FAST_BLAKE2B_H */
