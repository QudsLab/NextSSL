...
#ifndef NEXTSSL_CORE_PRIMITIVE_SLOW_MAKWA_H
#define NEXTSSL_CORE_PRIMITIVE_SLOW_MAKWA_H
 ...
 */
NEXTSSL_CORE_API int NEXTSSL_CORE_PRIMITIVE_SLOW_MAKWA_Hash(
 ...
 */
NEXTSSL_CORE_API int nextssl_partial_pow_makwa_verify(
    const uint8_t *password, size_t password_len,
    const uint8_t *salt, size_t salt_len,
    uint32_t work_factor,
 ...
 */
NEXTSSL_CORE_API int nextssl_partial_pow_makwa_selftest(void);

#endif /* NEXTSSL_CORE_PRIMITIVE_SLOW_MAKWA_H */
