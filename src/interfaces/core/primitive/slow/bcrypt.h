/**
 * @file bcrypt.h
 * @brief Layer 2 (Core) - bcrypt Password Hashing Interface
 * 
...
#ifndef NEXTSSL_CORE_PRIMITIVE_SLOW_BCRYPT_H
#define NEXTSSL_CORE_PRIMITIVE_SLOW_BCRYPT_H
...
NEXTSSL_CORE_PRIMITIVE_SLOW_BCRYPT_Hash(
...
#endif /* NEXTSSL_CORE_PRIMITIVE_SLOW_BCRYPT_H */
