...
#ifndef NEXTSSL_CORE_PRIMITIVE_SLOW_POMELO_H
#define NEXTSSL_CORE_PRIMITIVE_SLOW_POMELO_H
 ...
 */
NEXTSSL_CORE_API int NEXTSSL_CORE_PRIMITIVE_SLOW_POMELO_Hash(
 ...
 */
NEXTSSL_CORE_API int nextssl_partial_pow_pomelo_verify(
    const uint8_t *password, size_t password_len,
    const uint8_t *salt, size_t salt_len,
    uint32_t t_cost, uint32_t m_cost, uint32_t parallelism,
 ...
 */
NEXTSSL_CORE_API int nextssl_partial_pow_pomelo_selftest(void);

#endif /* NEXTSSL_CORE_PRIMITIVE_SLOW_POMELO_H */
