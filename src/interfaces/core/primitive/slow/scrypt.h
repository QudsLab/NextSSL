/**
 * @file scrypt.h
 * @brief Layer 2 (Core) - scrypt Password Hashing Interface
 * 
...
#ifndef NEXTSSL_CORE_PRIMITIVE_SLOW_SCRYPT_H
#define NEXTSSL_CORE_PRIMITIVE_SLOW_SCRYPT_H
...
#endif /* NEXTSSL_CORE_PRIMITIVE_SLOW_SCRYPT_H */
