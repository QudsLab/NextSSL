...
#ifndef NEXTSSL_CORE_PRIMITIVE_SLOW_ARGON2D_H
#define NEXTSSL_CORE_PRIMITIVE_SLOW_ARGON2D_H
 ...
 */
NEXTSSL_CORE_API int NEXTSSL_CORE_PRIMITIVE_SLOW_ARGON2D_Hash(
 ...
 */
NEXTSSL_CORE_API int nextssl_partial_pow_argon2d_verify(
    const uint8_t *password, size_t password_len,
 ...
 * @return 0 on success, negative on error
 */
NEXTSSL_CORE_API int nextssl_partial_pow_argon2d_encode(
    uint32_t t_cost, uint32_t m_cost, uint32_t parallelism,
    const uint8_t *salt, size_t salt_len,
 ...
 */
NEXTSSL_CORE_API int nextssl_partial_pow_argon2d_selftest(void);

#endif /* NEXTSSL_CORE_PRIMITIVE_SLOW_ARGON2D_H */
