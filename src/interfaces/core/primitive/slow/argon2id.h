/**
 * @file argon2id.h
 * @brief Layer 2 (Core) - Argon2id Password Hashing Interface
 * 
...
#ifndef NEXTSSL_CORE_PRIMITIVE_SLOW_ARGON2ID_H
#define NEXTSSL_CORE_PRIMITIVE_SLOW_ARGON2ID_H
...
NEXTSSL_CORE_PRIMITIVE_SLOW_ARGON2ID_Hash(
    uint32_t time_cost,
...
#endif /* NEXTSSL_CORE_PRIMITIVE_SLOW_ARGON2ID_H */
