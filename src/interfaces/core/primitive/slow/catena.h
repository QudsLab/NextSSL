...
#ifndef NEXTSSL_CORE_PRIMITIVE_SLOW_CATENA_H
#define NEXTSSL_CORE_PRIMITIVE_SLOW_CATENA_H
 ...
 */
NEXTSSL_CORE_API int NEXTSSL_CORE_PRIMITIVE_SLOW_CATENA_Hash(
 ...
 */
NEXTSSL_CORE_API int nextssl_partial_pow_catena_verify(
    const uint8_t *password, size_t password_len,
    const uint8_t *salt, size_t salt_len,
    uint8_t garlic, uint8_t lambda,
 ...
 */
NEXTSSL_CORE_API int nextssl_partial_pow_catena_selftest(void);

#endif /* NEXTSSL_CORE_PRIMITIVE_SLOW_CATENA_H */
