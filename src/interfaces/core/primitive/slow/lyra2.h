...
#ifndef NEXTSSL_CORE_PRIMITIVE_SLOW_LYRA2_H
#define NEXTSSL_CORE_PRIMITIVE_SLOW_LYRA2_H
 ...
 */
NEXTSSL_CORE_API int NEXTSSL_CORE_PRIMITIVE_SLOW_LYRA2_Hash(
 ...
 */
NEXTSSL_CORE_API int nextssl_partial_pow_lyra2_verify(
    const uint8_t *password, size_t password_len,
    const uint8_t *salt, size_t salt_len,
    uint32_t t_cost, uint32_t m_cost, uint32_t parallelism,
 ...
 */
NEXTSSL_CORE_API int nextssl_partial_pow_lyra2_selftest(void);

#endif /* NEXTSSL_CORE_PRIMITIVE_SLOW_LYRA2_H */
