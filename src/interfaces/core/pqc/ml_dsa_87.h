...
#ifndef NEXTSSL_CORE_PQC_ML_DSA_87_H
#define NEXTSSL_CORE_PQC_ML_DSA_87_H
 ...
 */
NEXTSSL_CORE_API int nextssl_partial_pqc_ml_dsa_87_keypair(
    uint8_t *public_key,
    uint8_t *secret_key);
 ...
 */
NEXTSSL_CORE_API int nextssl_partial_pqc_ml_dsa_87_sign(
    uint8_t *signature,
 ...
 */
NEXTSSL_CORE_API int nextssl_partial_pqc_ml_dsa_87_verify(
 ...
 */
NEXTSSL_CORE_API int nextssl_partial_pqc_ml_dsa_87_selftest(void);

#endif /* NEXTSSL_CORE_PQC_ML_DSA_87_H */
