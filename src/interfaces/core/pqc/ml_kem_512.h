...
#ifndef NEXTSSL_CORE_PQC_ML_KEM_512_H
#define NEXTSSL_CORE_PQC_ML_KEM_512_H
 ...
 */
NEXTSSL_CORE_API int nextssl_partial_pqc_ml_kem_512_keypair(
    uint8_t *public_key,
    uint8_t *secret_key);
 ...
 * @return 0 on success, negative on error
 */
NEXTSSL_CORE_API int nextssl_partial_pqc_ml_kem_512_encapsulate(
    uint8_t *ciphertext,
 ...
 */
NEXTSSL_CORE_API int nextssl_partial_pqc_ml_kem_512_decapsulate(
    uint8_t *shared_secret,
 ...
 */
NEXTSSL_CORE_API int nextssl_partial_pqc_ml_kem_512_selftest(void);

#endif /* NEXTSSL_CORE_PQC_ML_KEM_512_H */
