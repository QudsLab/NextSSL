...
#ifndef NEXTSSL_CORE_PQC_ML_DSA_44_H
#define NEXTSSL_CORE_PQC_ML_DSA_44_H
 ...
 */
NEXTSSL_CORE_API int nextssl_partial_pqc_ml_dsa_44_keypair(
    uint8_t *public_key,
    uint8_t *secret_key);
 ...
 */
NEXTSSL_CORE_API int nextssl_partial_pqc_ml_dsa_44_sign(
    uint8_t *signature,
 ...
 */
NEXTSSL_CORE_API int nextssl_partial_pqc_ml_dsa_44_verify(
 ...
 */
NEXTSSL_CORE_API int nextssl_partial_pqc_ml_dsa_44_selftest(void);

#endif /* NEXTSSL_CORE_PQC_ML_DSA_44_H */
