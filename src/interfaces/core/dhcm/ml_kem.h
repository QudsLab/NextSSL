/**
 * @file ml_kem.h
 * @brief Layer 2 (Core) - ML-KEM (Module-Lattice Key Encapsulation Mechanism) Interface
 * 
...
#ifndef NEXTSSL_CORE_DHCM_ML_KEM_H
#define NEXTSSL_CORE_DHCM_ML_KEM_H
...
#endif /* NEXTSSL_CORE_DHCM_ML_KEM_H */
