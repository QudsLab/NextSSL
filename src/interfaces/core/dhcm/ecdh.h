/**
 * @file ecdh.h
 * @brief Layer 2 (Core) - ECDH (Elliptic Curve Diffie-Hellman) Interface
 * 
...
#ifndef NEXTSSL_CORE_DHCM_ECDH_H
#define NEXTSSL_CORE_DHCM_ECDH_H
...
#endif /* NEXTSSL_CORE_DHCM_ECDH_H */
