/**
 * @file error.h
 * @brief Layer 2 (Core) - Error Handling Interface
 * 
...
#ifndef NEXTSSL_CORE_COMMON_ERROR_H
#define NEXTSSL_CORE_COMMON_ERROR_H
 ...
 */
NEXTSSL_CORE_API const char* nextssl_partial_core_error_string(int code);
 ...
 * @warning This is a PARTIAL interface. Use Layer 2+ for production.
 */
NEXTSSL_CORE_API nextssl_error_context_t nextssl_partial_core_error_create(
    int code,
 ...
 */
NEXTSSL_CORE_API void nextssl_partial_core_error_log(
...
NEXTSSL_CORE_API void nextssl_partial_core_error_set_handler(
...
#endif /* NEXTSSL_CORE_COMMON_ERROR_H */
