/**
 * @file timing.h
 * @brief Layer 2 (Core) - Timing-Safe Operations Interface
 * 
...
#ifndef NEXTSSL_CORE_COMMON_TIMING_H
#define NEXTSSL_CORE_COMMON_TIMING_H
 ...
 */
NEXTSSL_CORE_API uint8_t nextssl_partial_core_timing_select_byte(
    uint8_t condition,
    uint8_t a,
    uint8_t b
);
 ...
 * @warning This is a PARTIAL interface. Use Layer 2+ for production.
 */
NEXTSSL_CORE_API uint32_t nextssl_partial_core_timing_select_u32(
    uint32_t condition,
    uint32_t a,
    uint32_t b
);
 ...
 * @warning This is a PARTIAL interface. Use Layer 2+ for production.
 */
NEXTSSL_CORE_API uint64_t nextssl_partial_core_timing_select_u64(
    uint64_t condition,
    uint64_t a,
    uint64_t b
);
 ...
 * @warning This is a PARTIAL interface. Use Layer 2+ for production.
 */
NEXTSSL_CORE_API uint8_t nextssl_partial_core_timing_equal_byte(
    uint8_t a,
    uint8_t b
);
 ...
 * @warning This is a PARTIAL interface. Use Layer 2+ for production.
 */
NEXTSSL_CORE_API uint32_t nextssl_partial_core_timing_equal_u32(
    uint32_t a,
    uint32_t b
);
 ...
 * @warning This is a PARTIAL interface. Use Layer 2+ for production.
 */
NEXTSSL_CORE_API void nextssl_partial_core_timing_conditional_copy(
    uint8_t *dest,
    const uint8_t *src,
    size_t len,
    uint8_t condition
 ...
 */
NEXTSSL_CORE_API uint8_t nextssl_partial_core_timing_array_lookup(
    const uint8_t *array,
    size_t num_elements,
    size_t index
);
 ...
 */
NEXTSSL_CORE_API uint64_t nextssl_partial_core_timing_get_timestamp(void);

#ifdef __cplusplus
}
#endif

#endif /* NEXTSSL_CORE_COMMON_TIMING_H */
