/**
 * @file buffer.h
 * @brief Layer 2 (Core) - Secure Buffer Management Interface
 * 
...
#ifndef NEXTSSL_CORE_COMMON_BUFFER_H
#define NEXTSSL_CORE_COMMON_BUFFER_H
 ...
 */
NEXTSSL_CORE_API void nextssl_partial_core_buffer_secure_zero(
    void *ptr,
    size_t len
);
 ...
 */
NEXTSSL_CORE_API int nextssl_partial_core_buffer_constant_time_compare(
    const void *a,
    const void *b,
    size_t len
);
 ...
 * @warning This is a PARTIAL interface. Use Layer 2+ for production.
 */
NEXTSSL_CORE_API int nextssl_partial_core_buffer_safe_copy(
    void *dest,
    size_t dest_size,
    const void *src,
    size_t src_len
 ...
 */
NEXTSSL_CORE_API void* nextssl_partial_core_buffer_secure_alloc(
    size_t size
);
 ...
 * @warning This is a PARTIAL interface. Use Layer 2+ for production.
 */
NEXTSSL_CORE_API void nextssl_partial_core_buffer_secure_free(
    void *ptr,
    size_t size
);
...
#endif /* NEXTSSL_CORE_COMMON_BUFFER_H */
