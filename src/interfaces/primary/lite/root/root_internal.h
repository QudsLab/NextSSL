/**
 * @file root/root_internal.h (Lite)
 * @brief Internal helpers shared across lite root sub-modules (NOT public API).
 *
 * Include only from root/ implementation (.c) files, never from outside.
 */

#ifndef NEXTSSL_LITE_ROOT_INTERNAL_H
#define NEXTSSL_LITE_ROOT_INTERNAL_H
...
#endif /* NEXTSSL_LITE_ROOT_INTERNAL_H */
