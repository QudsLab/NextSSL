 ...
 * @brief NextSSL Root â€” Explicit elliptic-curve algorithm interface.
 *
 * Naming: nextssl_root_ecc_<curve>_<operation>(...)
 *
 * Curves:
 *   ed25519   â€” Edwards25519 signatures + X25519 DH
 *   curve448  â€” X448 Diffie-Hellman (Curve448/Goldilocks)
 *   r255      â€” Ristretto255 group operations
 *   elligator â€” Elligator2 map/inverse (key obfuscation)
 */
...
/* ------------------------------------------------------------------
 * Ristretto255 â€” prime-order group operations
...
/* ------------------------------------------------------------------
 * Elligator2 â€” steganographic key encoding
 * Maps a Curve25519 public key â†” an indistinguishable 32-byte string.
 * ------------------------------------------------------------------ */

/**
 * Forward map: hidden[32] uniform random â†’ curve point curve[32].
...
/**
 * Reverse map: curve point public_key[32] â†’ hidden representative hidden[32].
