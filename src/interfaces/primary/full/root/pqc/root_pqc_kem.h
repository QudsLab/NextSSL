 ...
 * @brief NextSSL Root â€” Explicit post-quantum KEM interface.
 *
 * Naming: nextssl_root_pqc_kem_<algorithm>_{keygen|encaps|decaps}(...)
 *
 * Key/ciphertext sizes (bytes) â€” use these to size your buffers:
 *
...
/* ================================================================
 * ML-KEM (Module Lattice-based KEM â€” NIST FIPS 203)
 * ============================================================== */
