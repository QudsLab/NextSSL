...
/*************************************************
* Name:        NEXTSSL_MLDSA44_power2round
*
...
/*************************************************
* Name:        NEXTSSL_MLDSA44_decompose
*
...
/*************************************************
* Name:        NEXTSSL_MLDSA44_make_hint
*
...
int32_t NEXTSSL_MLDSA44_use_hint(int32_t a, unsigned int hint) {
    ...
    a1 = NEXTSSL_MLDSA44_decompose(&a0, a);
    if (hint == 0) {
        return a1;
    }
