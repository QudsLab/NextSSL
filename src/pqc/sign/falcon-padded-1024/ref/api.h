#ifndef NEXTSSL_FALCONPADDED1024_API_H
#define NEXTSSL_FALCONPADDED1024_API_H

#include <stddef.h>
#include <stdint.h>

#define NEXTSSL_FALCONPADDED1024_CRYPTO_SECRETKEYBYTES   2305
#define NEXTSSL_FALCONPADDED1024_CRYPTO_PUBLICKEYBYTES   1793
#define NEXTSSL_FALCONPADDED1024_CRYPTO_BYTES            1280

#define NEXTSSL_FALCONPADDED1024_CRYPTO_ALGNAME          "Falcon-padded-1024"

/*
 * Generate a new key pair. Public key goes into pk[], private key in sk[].
 * Key sizes are exact (in bytes):
 *   public (pk): NEXTSSL_FALCONPADDED1024_CRYPTO_PUBLICKEYBYTES
 *   private (sk): NEXTSSL_FALCONPADDED1024_CRYPTO_SECRETKEYBYTES
 *
 * Return value: 0 on success, -1 on error.
 */
int NEXTSSL_FALCONPADDED1024_crypto_sign_keypair(
 ...
 * (in bytes) is NEXTSSL_FALCONPADDED1024_CRYPTO_BYTES.
 *
 * sig[], m[] and sk[] may overlap each other arbitrarily.
 *
 * Return value: 0 on success, -1 on error.
 */
int NEXTSSL_FALCONPADDED1024_crypto_sign_signature(
 ...
 * Return value: 0 on success, -1 on error.
 */
int NEXTSSL_FALCONPADDED1024_crypto_sign_verify(
 ...
 * (mlen) by up to NEXTSSL_FALCONPADDED1024_CRYPTO_BYTES.
 *
 ...
 * Return value: 0 on success, -1 on error.
 */
int NEXTSSL_FALCONPADDED1024_crypto_sign(
 ...
 * may range up to NEXTSSL_FALCONPADDED1024_CRYPTO_BYTES.
 *
 * m[], sm[] and pk[] may overlap each other arbitrarily.
 *
 * Return value: 0 on success, -1 on error.
 */
int NEXTSSL_FALCONPADDED1024_crypto_sign_open(
