...
/*************************************************
* Name:        NEXTSSL_MLDSA87_power2round
*
...
/*************************************************
* Name:        NEXTSSL_MLDSA87_decompose
*
...
/*************************************************
* Name:        NEXTSSL_MLDSA87_make_hint
*
...
int32_t NEXTSSL_MLDSA87_use_hint(int32_t a, unsigned int hint) {
    ...
    a1 = NEXTSSL_MLDSA87_decompose(&a0, a);
    if (hint == 0) {
        return a1;
    }
