...
/*************************************************
* Name:        NEXTSSL_MLDSA87_poly_reduce
*
...
void NEXTSSL_MLDSA87_poly_reduce(poly *a) {
    ...
    for (i = 0; i < N; ++i) {
        a->coeffs[i] = NEXTSSL_MLDSA87_reduce32(a->coeffs[i]);
    }
...
/*************************************************
* Name:        NEXTSSL_MLDSA87_poly_caddq
*
...
void NEXTSSL_MLDSA87_poly_caddq(poly *a) {
    ...
    for (i = 0; i < N; ++i) {
        a->coeffs[i] = NEXTSSL_MLDSA87_caddq(a->coeffs[i]);
    }
...
/*************************************************
* Name:        NEXTSSL_MLDSA87_poly_shiftl
*
...
void NEXTSSL_MLDSA87_poly_ntt(poly *a) {
    ...
    NEXTSSL_MLDSA87_ntt(a->coeffs);

    DBENCH_STOP(*tmul);
}

/*************************************************
* Name:        NEXTSSL_MLDSA87_poly_invntt_tomont
*
...
void NEXTSSL_MLDSA87_poly_invntt_tomont(poly *a) {
    ...
    NEXTSSL_MLDSA87_invntt_tomont(a->coeffs);

    DBENCH_STOP(*tmul);
}

/*************************************************
* Name:        NEXTSSL_MLDSA87_poly_pointwise_montgomery
*
...
void NEXTSSL_MLDSA87_poly_pointwise_montgomery(poly *c, const poly *a, const poly *b) {
    ...
    for (i = 0; i < N; ++i) {
        c->coeffs[i] = NEXTSSL_MLDSA87_montgomery_reduce((int64_t)a->coeffs[i] * b->coeffs[i]);
    }
...
/*************************************************
* Name:        NEXTSSL_MLDSA87_poly_power2round
*
...
void NEXTSSL_MLDSA87_poly_power2round(poly *a1, poly *a0, const poly *a) {
    ...
    for (i = 0; i < N; ++i) {
        a1->coeffs[i] = NEXTSSL_MLDSA87_power2round(&a0->coeffs[i], a->coeffs[i]);
    }
...
/*************************************************
* Name:        NEXTSSL_MLDSA87_poly_decompose
*
* Description: For all coefficients c of the input polynomial,
...
void NEXTSSL_MLDSA87_poly_decompose(poly *a1, poly *a0, const poly *a) {
    ...
    for (i = 0; i < N; ++i) {
        a1->coeffs[i] = NEXTSSL_MLDSA87_decompose(&a0->coeffs[i], a->coeffs[i]);
    }
...
/*************************************************
* Name:        NEXTSSL_MLDSA87_poly_make_hint
*
...
unsigned int NEXTSSL_MLDSA87_poly_make_hint(poly *h, const poly *a0, const poly *a1) {
    ...
    for (i = 0; i < N; ++i) {
        h->coeffs[i] = NEXTSSL_MLDSA87_make_hint(a0->coeffs[i], a1->coeffs[i]);
        s += h->coeffs[i];
    }
...
/*************************************************
* Name:        NEXTSSL_MLDSA87_poly_use_hint
*
...
void NEXTSSL_MLDSA87_poly_use_hint(poly *b, const poly *a, const poly *h) {
    ...
    for (i = 0; i < N; ++i) {
        b->coeffs[i] = NEXTSSL_MLDSA87_use_hint(a->coeffs[i], h->coeffs[i]);
    }
...
/*************************************************
* Name:        NEXTSSL_MLDSA87_poly_chknorm
*
* Description: Check infinity norm of polynomial against given bound.
*              Assumes input coefficients were reduced by NEXTSSL_MLDSA87_reduce32().
*
...
/*************************************************
* Name:        NEXTSSL_MLDSA87_poly_uniform
*
...
/*************************************************
* Name:        NEXTSSL_MLDSA87_poly_uniform_eta
*
* Description: Sample polynomial with uniformly random coefficients
...
void NEXTSSL_MLDSA87_poly_uniform_gamma1(poly *a,
    ...
    stream256_release(&state);
    NEXTSSL_MLDSA87_polyz_unpack(a, buf);
}
...
/*************************************************
* Name:        NEXTSSL_MLDSA87_polyeta_pack
*
...
/*************************************************
* Name:        NEXTSSL_MLDSA87_polyeta_unpack
*
...
/*************************************************
* Name:        NEXTSSL_MLDSA87_polyt1_pack
*
...
/*************************************************
* Name:        NEXTSSL_MLDSA87_polyt1_unpack
*
...
/*************************************************
* Name:        NEXTSSL_MLDSA87_polyt0_pack
*
...
/*************************************************
* Name:        NEXTSSL_MLDSA87_polyt0_unpack
*
...
/*************************************************
* Name:        NEXTSSL_MLDSA87_polyz_pack
*
...
/*************************************************
* Name:        NEXTSSL_MLDSA87_polyz_unpack
*
...
/*************************************************
* Name:        NEXTSSL_MLDSA87_polyw1_pack
*
