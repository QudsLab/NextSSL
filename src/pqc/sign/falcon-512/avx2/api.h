#ifndef NEXTSSL_FALCON512_AVX2_API_H
#define NEXTSSL_FALCON512_AVX2_API_H

#include <stddef.h>
#include <stdint.h>

#define NEXTSSL_FALCON512_AVX2_CRYPTO_SECRETKEYBYTES   1281
#define NEXTSSL_FALCON512_AVX2_CRYPTO_PUBLICKEYBYTES   897
#define NEXTSSL_FALCON512_AVX2_CRYPTO_BYTES            752

#define NEXTSSL_FALCON512_AVX2_CRYPTO_ALGNAME          "Falcon-512"

#define NEXTSSL_FALCONPADDED512_AVX2_CRYPTO_BYTES      666 // used in signature verification

/*
 * Generate a new key pair. Public key goes into pk[], private key in sk[].
 * Key sizes are exact (in bytes):
 *   public (pk): NEXTSSL_FALCON512_AVX2_CRYPTO_PUBLICKEYBYTES
 *   private (sk): NEXTSSL_FALCON512_AVX2_CRYPTO_SECRETKEYBYTES
 *
 * Return value: 0 on success, -1 on error.
 */
int NEXTSSL_FALCON512_AVX2_crypto_sign_keypair(
 ...
 * (in bytes) is NEXTSSL_FALCON512_AVX2_CRYPTO_BYTES.
 *
 * sig[], m[] and sk[] may overlap each other arbitrarily.
 *
 * Return value: 0 on success, -1 on error.
 */
int NEXTSSL_FALCON512_AVX2_crypto_sign_signature(
 ...
 * Return value: 0 on success, -1 on error.
 */
int NEXTSSL_FALCON512_AVX2_crypto_sign_verify(
 ...
 * (mlen) by up to NEXTSSL_FALCON512_AVX2_CRYPTO_BYTES.
 *
 ...
 * Return value: 0 on success, -1 on error.
 */
int NEXTSSL_FALCON512_AVX2_crypto_sign(
 ...
 * may range up to NEXTSSL_FALCON512_AVX2_CRYPTO_BYTES.
 *
 * m[], sm[] and pk[] may overlap each other arbitrarily.
 *
 * Return value: 0 on success, -1 on error.
 */
int NEXTSSL_FALCON512_AVX2_crypto_sign_open(
