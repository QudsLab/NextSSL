...
void NEXTSSL_FALCONPADDED512_AARCH64_poly_ntt(int16_t a[FALCON_N], ntt_domain_t mont) {
    ...
    const int16_t *ptr_ntt_br = NEXTSSL_FALCONPADDED512_AARCH64_ntt_br;
    const int16_t *ptr_ntt_qinv_br = NEXTSSL_FALCONPADDED512_AARCH64_ntt_qinv_br;

    neon_qmvq = vld1q_s16(NEXTSSL_FALCONPADDED512_AARCH64_qmvq);
...
void NEXTSSL_FALCONPADDED512_AARCH64_poly_invntt(int16_t a[FALCON_N], invntt_domain_t ninv) {
    ...
    int16x8x2_t zlh, zhh;       // 4
    int16x8_t neon_qmvq;        // 1
    const int16_t *ptr_invntt_br = NEXTSSL_FALCONPADDED512_AARCH64_invntt_br;
    const int16_t *ptr_invntt_qinv_br = NEXTSSL_FALCONPADDED512_AARCH64_invntt_qinv_br;
