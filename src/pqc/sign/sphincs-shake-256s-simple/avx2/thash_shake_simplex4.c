...
void thashx4(unsigned char *out0,
    ...
    if (inblocks == 1 || inblocks == 2) {
        ...
        NEXTSSL_VLA(unsigned char, buf0, SPX_N + SPX_ADDR_BYTES + (inblocks * SPX_N));
        NEXTSSL_VLA(unsigned char, buf1, SPX_N + SPX_ADDR_BYTES + (inblocks * SPX_N));
        NEXTSSL_VLA(unsigned char, buf2, SPX_N + SPX_ADDR_BYTES + (inblocks * SPX_N));
        NEXTSSL_VLA(unsigned char, buf3, SPX_N + SPX_ADDR_BYTES + (inblocks * SPX_N));
