...
/*************************************************
* Name:        NEXTSSL_MLDSA65_power2round
*
...
/*************************************************
* Name:        NEXTSSL_MLDSA65_decompose
*
...
/*************************************************
* Name:        NEXTSSL_MLDSA65_make_hint
*
...
int32_t NEXTSSL_MLDSA65_use_hint(int32_t a, unsigned int hint) {
    ...
    a1 = NEXTSSL_MLDSA65_decompose(&a0, a);
    if (hint == 0) {
        return a1;
    }
