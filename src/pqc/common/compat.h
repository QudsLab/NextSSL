#ifndef  NEXTSSL_COMMON_COMPAT_H
#define NEXTSSL_COMMON_COMPAT_H
...
# define NEXTSSL_VLA(__t,__x,__s) __t *__x = (__t*)_alloca((__s)*sizeof(__t))
#else
# define NEXTSSL_VLA(__t,__x,__s) __t __x[__s]
#endif
