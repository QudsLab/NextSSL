...
/*************************************************
* Name:        NEXTSSL_MLKEM1024_AVX2_polyvec_compress
*
...
/*************************************************
* Name:        NEXTSSL_MLKEM1024_AVX2_polyvec_decompress
*
* Description: De-serialize and decompress vector of polynomials;
*              approximate inverse of NEXTSSL_MLKEM1024_AVX2_polyvec_compress
*
...
/*************************************************
* Name:        NEXTSSL_MLKEM1024_AVX2_polyvec_tobytes
*
...
void NEXTSSL_MLKEM1024_AVX2_polyvec_tobytes(uint8_t r[KYBER_POLYVECBYTES], const polyvec *a) {
    size_t i;
    for (i = 0; i < KYBER_K; i++) {
        NEXTSSL_MLKEM1024_AVX2_poly_tobytes(r + i * KYBER_POLYBYTES, &a->vec[i]);
    }
}

/*************************************************
* Name:        NEXTSSL_MLKEM1024_AVX2_polyvec_frombytes
*
* Description: De-serialize vector of polynomials;
*              inverse of NEXTSSL_MLKEM1024_AVX2_polyvec_tobytes
*
* Arguments:   - uint8_t *r: pointer to output byte array
...
void NEXTSSL_MLKEM1024_AVX2_polyvec_frombytes(polyvec *r, const uint8_t a[KYBER_POLYVECBYTES]) {
    size_t i;
    for (i = 0; i < KYBER_K; i++) {
        NEXTSSL_MLKEM1024_AVX2_poly_frombytes(&r->vec[i], a + i * KYBER_POLYBYTES);
    }
}

/*************************************************
* Name:        NEXTSSL_MLKEM1024_AVX2_polyvec_ntt
*
...
void NEXTSSL_MLKEM1024_AVX2_polyvec_ntt(polyvec *r) {
    size_t i;
    for (i = 0; i < KYBER_K; i++) {
        NEXTSSL_MLKEM1024_AVX2_poly_ntt(&r->vec[i]);
    }
}

/*************************************************
* Name:        NEXTSSL_MLKEM1024_AVX2_polyvec_invntt_tomont
*
...
void NEXTSSL_MLKEM1024_AVX2_polyvec_invntt_tomont(polyvec *r) {
    size_t i;
    for (i = 0; i < KYBER_K; i++) {
        NEXTSSL_MLKEM1024_AVX2_poly_invntt_tomont(&r->vec[i]);
    }
}

/*************************************************
* Name:        NEXTSSL_MLKEM1024_AVX2_polyvec_basemul_acc_montgomery
*
...
void NEXTSSL_MLKEM1024_AVX2_polyvec_basemul_acc_montgomery(poly *r, const polyvec *a, const polyvec *b) {
    ...
    NEXTSSL_MLKEM1024_AVX2_poly_basemul_montgomery(r, &a->vec[0], &b->vec[0]);
    for (i = 1; i < KYBER_K; i++) {
        NEXTSSL_MLKEM1024_AVX2_poly_basemul_montgomery(&tmp, &a->vec[i], &b->vec[i]);
        NEXTSSL_MLKEM1024_AVX2_poly_add(r, r, &tmp);
    }
}

/*************************************************
* Name:        NEXTSSL_MLKEM1024_AVX2_polyvec_reduce
*
...
void NEXTSSL_MLKEM1024_AVX2_polyvec_reduce(polyvec *r) {
    size_t i;
    for (i = 0; i < KYBER_K; i++) {
        NEXTSSL_MLKEM1024_AVX2_poly_reduce(&r->vec[i]);
    }
}

/*************************************************
* Name:        NEXTSSL_MLKEM1024_AVX2_polyvec_add
*
...
void NEXTSSL_MLKEM1024_AVX2_polyvec_add(polyvec *r, const polyvec *a, const polyvec *b) {
    size_t i;
    for (i = 0; i < KYBER_K; i++) {
        NEXTSSL_MLKEM1024_AVX2_poly_add(&r->vec[i], &a->vec[i], &b->vec[i]);
    }
}
