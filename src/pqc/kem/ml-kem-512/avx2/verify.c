...
/*************************************************
* Name:        NEXTSSL_MLKEM512_AVX2_verify
*
...
/*************************************************
* Name:        NEXTSSL_MLKEM512_AVX2_cmov
*
...
**************************************************/
void NEXTSSL_MLKEM512_AVX2_cmov(uint8_t *restrict r, const uint8_t *x, size_t len, uint8_t b) {
    size_t i;
