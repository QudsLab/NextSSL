 ...
 */
void NEXTSSL_HQC192_seedexpander_init(seedexpander_state *state, const uint8_t *seed, size_t seedlen) {
 ...
 */
void NEXTSSL_HQC192_seedexpander(seedexpander_state *state, uint8_t *output, size_t outlen) {
 ...
 */
void NEXTSSL_HQC192_seedexpander_release(seedexpander_state *state) {
