...
#define SECRET_KEY_BYTES                        NEXTSSL_HQC192_CRYPTO_SECRETKEYBYTES
#define PUBLIC_KEY_BYTES                        NEXTSSL_HQC192_CRYPTO_PUBLICKEYBYTES
#define SHARED_SECRET_BYTES                     NEXTSSL_HQC192_CRYPTO_BYTES
#define CIPHERTEXT_BYTES                        NEXTSSL_HQC192_CRYPTO_CIPHERTEXTBYTES
