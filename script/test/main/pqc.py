...
def main() -> int:
    ...
    _mceliece_variants = [
        ("McEliece-348864",  261120,  6492,  96, 32, 'mceliece348864'),
        ("McEliece-348864f", 261120,  6492,  96, 32, 'mceliece348864f'),
        ("McEliece-460896",  524160, 13608, 156, 32, 'mceliece460896'),
        ("McEliece-460896f", 524160, 13608, 156, 32, 'mceliece460896f'),
        ("McEliece-6688128", 1044992, 13932, 208, 32, 'mceliece6688128'),
        ("McEliece-6688128f",1044992, 13932, 208, 32, 'mceliece6688128f'),
        ("McEliece-6960119", 1047319, 13948, 194, 32, 'mceliece6960119'),
        ("McEliece-6960119f",1047319, 13948, 194, 32, 'mceliece6960119f'),
        ("McEliece-8192128", 1357824, 14120, 208, 32, 'mceliece8192128'),
        ("McEliece-8192128f",1357824, 14120, 208, 32, 'mceliece8192128f'),
    ]
