...
def main(color=True):
    ...
    funcs = [
        ...
        ('nextssl_sha0', 20),
        ('nextssl_has160', 20),
        ('nextssl_ripemd128', 16),
        ('nextssl_ripemd256', 32),
        ('nextssl_ripemd320', 40),
    ]
    ...
    # MD2
    run_test("MD2 empty", "nextssl_md2", "", "8350e5a3e24c153df2275c9f80692773", 16)
    run_test("MD2 'abc'", "nextssl_md2", "abc", "da853b0d3f88d99b30283a69e6ded6bb", 16)

    # MD4
    run_test("MD4 empty", "nextssl_md4", "", "31d6cfe0d16ae931b73c59d7e0c089c0", 16)
    run_test("MD4 'abc'", "nextssl_md4", "abc", "a448017aaf21d8525fc10ae87aa6729d", 16)

    # SHA-0
    run_test("SHA-0 'abc'", "nextssl_sha0", "abc", "0164b8a914cd2a5e74c4f7ff082c4d97f1edf880", 20)

    # HAS-160
    run_test("HAS-160 empty", "nextssl_has160", "", "307964ef34151d37c8047adec7ab50f4ff89762d", 20)

    # RIPEMD-128
    run_test("RIPEMD-128 empty", "nextssl_ripemd128", "", "cdf26213a150dc3ecb610f18f6b38b46", 16)
    ...
    run_test("RIPEMD-128 'abc'", "nextssl_ripemd128", "abc", "c14a12199c66e4ba84636b0f69144c77", 16)

    # RIPEMD-256
    run_test("RIPEMD-256 empty", "nextssl_ripemd256", "", "02ba4c4e5f8ecd1877fc52d64d30e37a2d9774fb1e5d026380ae0168e3c5522d", 32)

    # RIPEMD-320
    run_test("RIPEMD-320 empty", "nextssl_ripemd320", "", "22d65d5661536cdc75c1fdf5c6de7b41b9f27325ebc61e8557177d705a0ec880151c3a32a00899b8", 40)
