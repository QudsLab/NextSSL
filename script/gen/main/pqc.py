...
_WASM_PQC_EXPORTS = [
    ...
    # Use _MCELIECE_SYMBOLS below when verifying native exports.
    # ── Sign: ML-DSA ─────────────────────────────────────────────────────────
...
# McEliece symbols present in native binaries but intentionally excluded from
# pqc.wasm (public keys 256 KB – 1.3 MB are impractical in WebAssembly).
# Pass this list as intentionally_excluded= when auditing pqc.wasm exports.
_MCELIECE_SYMBOLS = [
    'pqc_mceliece348864_keypair',    'pqc_mceliece348864_keypair_derand',
    'pqc_mceliece348864_encaps',     'pqc_mceliece348864_encaps_derand',
    'pqc_mceliece348864_decaps',
    'pqc_mceliece348864f_keypair',   'pqc_mceliece348864f_keypair_derand',
    'pqc_mceliece348864f_encaps',    'pqc_mceliece348864f_encaps_derand',
    'pqc_mceliece348864f_decaps',
    'pqc_mceliece460896_keypair',    'pqc_mceliece460896_keypair_derand',
    'pqc_mceliece460896_encaps',     'pqc_mceliece460896_encaps_derand',
    'pqc_mceliece460896_decaps',
    'pqc_mceliece460896f_keypair',   'pqc_mceliece460896f_keypair_derand',
    'pqc_mceliece460896f_encaps',    'pqc_mceliece460896f_encaps_derand',
    'pqc_mceliece460896f_decaps',
    'pqc_mceliece6688128_keypair',   'pqc_mceliece6688128_keypair_derand',
    'pqc_mceliece6688128_encaps',    'pqc_mceliece6688128_encaps_derand',
    'pqc_mceliece6688128_decaps',
    'pqc_mceliece6688128f_keypair',  'pqc_mceliece6688128f_keypair_derand',
    'pqc_mceliece6688128f_encaps',   'pqc_mceliece6688128f_encaps_derand',
    'pqc_mceliece6688128f_decaps',
    'pqc_mceliece6960119_keypair',   'pqc_mceliece6960119_keypair_derand',
    'pqc_mceliece6960119_encaps',    'pqc_mceliece6960119_encaps_derand',
    'pqc_mceliece6960119_decaps',
    'pqc_mceliece6960119f_keypair',  'pqc_mceliece6960119f_keypair_derand',
    'pqc_mceliece6960119f_encaps',   'pqc_mceliece6960119f_encaps_derand',
    'pqc_mceliece6960119f_decaps',
    'pqc_mceliece8192128_keypair',   'pqc_mceliece8192128_keypair_derand',
    'pqc_mceliece8192128_encaps',    'pqc_mceliece8192128_encaps_derand',
    'pqc_mceliece8192128_decaps',
    'pqc_mceliece8192128f_keypair',  'pqc_mceliece8192128f_keypair_derand',
    'pqc_mceliece8192128f_encaps',   'pqc_mceliece8192128f_encaps_derand',
    'pqc_mceliece8192128f_decaps',
]
...
def build(builder: Builder):
    ...
    # Add shared randomness layer — PQCrypto/common/drbg intentionally excluded:
    # randombytes.c already includes ../../seed/drbg/drbg.h directly, so
    # PQCrypto/common/drbg/drbg.c would cause duplicate symbol errors.
    ...
    # Add seed/ support layer: needed by randombytes.c and pqc_main.c → rootkey.c
    for seed_file in [
        os.path.join(src_dir, 'seed/drbg/drbg.c'),
        os.path.join(src_dir, 'seed/rng/rng.c'),
        os.path.join(src_dir, 'seed/udbf/udbf.c'),
        os.path.join(src_dir, 'seed/udbf/rootkey.c'),
    ]:
        sources.append(seed_file)

    # Add wrapper (pqc_main.c exports all pqc_*_keypair_derand etc.)
    wrapper = os.path.join(src_dir, 'PQCrypto/pqc_main.c')
