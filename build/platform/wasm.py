...
def collect_sources() -> list:
    exclude_patterns = [
        ...
        "/pqc/common/keccak4x/",
        "/avx2/",
        "/memory_hard/balloon/balloon.c",
        "/memory_hard/scrypt/sha256.c",
